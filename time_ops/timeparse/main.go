...
func main() {
	...
	tt, err := locTime("America/New_York", "15:04", os.Args[1])
	if err != nil {
		fmt.Println("There is an error ", err)
		os.Exit(1)
	}
	fmt.Println(tt)
	tt, err = locTime("Local", "15:04", os.Args[1])
	if err != nil {
		fmt.Println("There is an error ", err)
		os.Exit(1)
	}
	...
	tt, err = locTime("Europe/London", "15:04", os.Args[1])
	if err != nil {
		fmt.Println("There is an error ", err)
		os.Exit(1)
	}
	fmt.Println(tt)
	tt, err = locTime("Asia/Tokyo", "15:04", os.Args[1])
	if err != nil {
		fmt.Println("There is an error ", err)
		os.Exit(1)
	}
